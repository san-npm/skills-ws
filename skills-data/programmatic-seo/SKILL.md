...
description: "Template pages at scale for SEO. Directory pages, location pages, comparison pages, integration pages, glossary pages. Data pipeline design, template creation, internal linking at scale, avoiding thin content penalties. Use when building SEO pages at scale, creating directory sites, generating location pages, making comparison or versus pages, or designing template-based content systems."
---
...
Detailed templates by type: [references/template-patterns.md](references/template-patterns.md)
Data pipeline architecture: [references/data-pipeline.md](references/data-pipeline.md)

## References

- [references/template-patterns.md](references/template-patterns.md) — Templates for each page type
- [references/data-pipeline.md](references/data-pipeline.md) — Data collection and generation pipelines
