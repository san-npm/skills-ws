---
name: virustotal
description: "URL, file, domain, and IP scanning via VirusTotal CLI and API. Threat detection, reputation checks, malware analysis, phishing detection. Requires VT API key (VT_API_KEY env var) or vt CLI configured. Use when scanning URLs for malware, checking domain reputation, analyzing suspicious files, auditing website security, or verifying link safety."
---
