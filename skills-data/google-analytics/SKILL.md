...
description: "GA4 setup, event taxonomy design, custom dimensions, conversion tracking, audience segments, Looker Studio reporting, cross-domain tracking, and attribution settings. Use when setting up GA4, designing measurement plans, implementing event tracking, building dashboards, or debugging analytics."
---
