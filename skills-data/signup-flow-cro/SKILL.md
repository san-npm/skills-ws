...
description: "Registration and signup flow optimization. Friction reduction, progressive profiling, social login, email verification flows, password requirements, onboarding handoff, multi-step forms. Use when optimizing signup flows, reducing registration friction, implementing social login, designing email verification, improving trial activation, or increasing registration completion rates."
---
...
- [references/signup-patterns.md](references/signup-patterns.md) — Signup form patterns and examples
- [references/friction-checklist.md](references/friction-checklist.md) — 25-point friction audit
