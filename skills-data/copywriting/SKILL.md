---
name: copywriting
description: "Marketing copy for any page type: homepage, landing, pricing, feature, about, product pages. Headline frameworks (PAS, AIDA, 4Us, BAB, PASTOR), CTA optimization, voice and tone guidelines, before/after rewrites, value proposition crafting. Use when writing marketing copy, improving headlines, crafting CTAs, rewriting page copy, creating value propositions, or optimizing conversion-focused text."
---
...
Full frameworks and 50+ swipe patterns: [references/frameworks.md](references/frameworks.md)
...
- [references/frameworks.md](references/frameworks.md) — PAS, AIDA, BAB, PASTOR, StoryBrand + 50 swipe patterns
- [references/swipe-file.md](references/swipe-file.md) — Proven copy examples by page type
