---
name: seo-geo
description: "SEO & GEO (Generative Engine Optimization) for websites. Technical SEO audits, keyword research, schema markup (JSON-LD), Core Web Vitals, E-E-A-T optimization, international SEO (hreflang), and AI search engine optimization for ChatGPT, Perplexity, Gemini, Google AI Overview, Copilot, and Claude. Use when improving search visibility, search ranking, AI citations, indexing, meta tags, structured data, keyword clustering, content optimization, or competitor analysis."
---
...
Full technical checklist (Core Web Vitals, crawl budget, mobile-first): [references/technical-seo.md](references/technical-seo.md)
...
Cluster by intent: informational → blog, transactional → landing pages, navigational → product pages. Full methodology: [references/keyword-research.md](references/keyword-research.md)
...
Platform-specific strategies: [references/geo-optimization.md](references/geo-optimization.md)
...
Full guide: [references/eeat-guide.md](references/eeat-guide.md)
...
Full guide: [references/international-seo.md](references/international-seo.md)
...
- [references/technical-seo.md](references/technical-seo.md) — Core Web Vitals, crawlability, indexing
- [references/geo-optimization.md](references/geo-optimization.md) — AI search strategies per platform
- [references/schema-templates.md](references/schema-templates.md) — JSON-LD for 10+ page types
- [references/keyword-research.md](references/keyword-research.md) — Clustering, intent mapping, gap analysis
- [references/eeat-guide.md](references/eeat-guide.md) — E-E-A-T signals and implementation
- [references/international-seo.md](references/international-seo.md) — hreflang, geo-targeting, multilingual
