...
description: "Multi-platform social media content creation for LinkedIn, Twitter/X, Instagram, TikTok. Content repurposing workflows, optimal posting times, engagement tactics, hashtag strategy, thread structures, carousel templates, content calendars. Use when creating social media posts, repurposing content across platforms, planning social media calendars, writing LinkedIn posts, crafting Twitter threads, or building engagement strategies."
---
...
See [references/content-calendar.md](references/content-calendar.md) for weekly planning template.

## References

- [references/platform-guides.md](references/platform-guides.md) — Detailed specs and best practices per platform
- [references/content-calendar.md](references/content-calendar.md) — Weekly planning template with content mix
