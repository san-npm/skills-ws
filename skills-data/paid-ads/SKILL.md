---
name: paid-ads
description: "Paid advertising on Google Ads, Meta (Facebook/Instagram), LinkedIn, Twitter/X. Campaign structure, ad copy formulas, audience targeting, bidding strategies, ROAS optimization, A/B testing, negative keywords, retargeting, lookalike audiences. Use when creating ad campaigns, writing ad copy, setting up audience targeting, optimizing ROAS/CPA, planning paid media budgets, or designing retargeting flows."
---
...
Platform specs and character limits: [references/platform-specs.md](references/platform-specs.md)
...
- [references/platform-specs.md](references/platform-specs.md) — Character limits, image sizes, placements per platform
- [references/ad-copy-formulas.md](references/ad-copy-formulas.md) — 30+ proven ad copy templates
