...
description: "End-to-end landing page creation: copy, design, code. Section-by-section builder (hero, features, social proof, pricing, FAQ, CTA). Outputs HTML/Tailwind or React components. Conversion principles, responsive design, accessibility. Use when building landing pages, creating marketing pages, designing hero sections, coding page sections with Tailwind, or generating full page layouts."
---
...
## Section templates with Tailwind code: [references/section-templates.md](references/section-templates.md)

## Conversion principles: [references/conversion-principles.md](references/conversion-principles.md)

## References

- [references/section-templates.md](references/section-templates.md) — HTML/Tailwind code for each section type
- [references/conversion-principles.md](references/conversion-principles.md) — Design principles for conversion
