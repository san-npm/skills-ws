---
name: search-console
description: "Google Search Console optimization. Index coverage audits, performance analysis (CTR, position, impressions), sitemap management, Core Web Vitals debugging, URL inspection, rich results validation, and search appearance optimization. Use when diagnosing indexing issues, analyzing search performance, debugging structured data, or improving click-through rates."
---
