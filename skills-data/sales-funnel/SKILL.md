---
name: sales-funnel
description: "Full funnel design: awareness, consideration, decision, retention. Touchpoint mapping, lead magnets, nurture sequences, objection handling, upsell and cross-sell strategies, funnel analytics. Use when designing sales funnels, creating lead magnets, mapping customer journeys, handling objections, planning upsell strategies, or optimizing conversion funnels."
---
...
Common objections and responses: [references/objection-handling.md](references/objection-handling.md)

## Funnel Templates

Detailed funnel blueprints by business type: [references/funnel-templates.md](references/funnel-templates.md)

## References

- [references/funnel-templates.md](references/funnel-templates.md) — Complete funnel blueprints
- [references/objection-handling.md](references/objection-handling.md) — Top 15 objections with responses
