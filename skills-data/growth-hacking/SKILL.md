---
name: growth-hacking
description: "Viral loops, referral programs, product-led growth (PLG) tactics, activation funnels, retention hooks, experimentation frameworks (ICE, RICE, PIE), growth metrics (AARRR pirate metrics), network effects, habit loops. Use when designing viral mechanics, building referral programs, implementing PLG strategies, creating experiment backlogs, optimizing activation rates, or improving user retention."
---
...
Design details: [references/viral-mechanics.md](references/viral-mechanics.md)
...
PLG playbook: [references/plg-playbook.md](references/plg-playbook.md)
...
Details: [references/experiment-frameworks.md](references/experiment-frameworks.md)
...
- [references/viral-mechanics.md](references/viral-mechanics.md) — Viral loop templates and examples
- [references/plg-playbook.md](references/plg-playbook.md) — PLG implementation guide
- [references/experiment-frameworks.md](references/experiment-frameworks.md) — ICE, RICE, PIE frameworks with templates
