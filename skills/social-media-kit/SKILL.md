...
- **Stories:** 15-second segments, ephemeral, great for polls/stickers/link sticker (link sticker is available to all accounts now).
...
- **Testimonials & results claims:** endorsements must reflect **honest, typical** experience; non-typical results need a disclaimer. Keep **written consent** on file before reposting a customer's words/face/UGC. Don't fabricate or incentivize reviews without disclosure.
