...
|---------|------------------------|------------------------|-------------|
| Austria | ~21% | ~18% | Höchstbeitragsgrundlage ~€6,930/month (2026); verify at [oegk.at](https://www.gesundheitskasse.at/) |
| Belgium | ~25% (after structural reduction) | ~13.07% | No ceiling for most contributions |
| Bulgaria | ~18-19% | ~13-14% | Ceiling reset annually (BGN); verify at [NRA](https://nra.bg/) — note Bulgaria adopts the euro from 1 Jan 2026 |
...
| Czech Republic | ~33.8% | ~11% (incl. 7.1% health) | Social security ceiling ~CZK 2.4M/year (48× avg wage); verify yearly at [ČSSZ](https://www.cssz.cz/) |
...
| France | ~40-45% | ~22-25% | Multiple ceilings. **PASS 2026** — confirm the exact figure at [urssaf.fr](https://www.urssaf.fr/accueil/outils-documentation/taux-baremes/plafonds-securite-sociale.html) (published sources differ); many contributions uncapped. |
...
| Greece | ~22% | ~14% | Ceiling on insurable earnings applies; verify at [EFKA](https://www.efka.gov.gr/) |
...
| Italy | ~30% | ~9-10% | Ceiling (massimale) applies to some components, mainly post-1996 entrants; verify at [INPS](https://www.inps.it/) |
| Latvia | ~23.59% | ~10.50% | Annual cap on mandatory contributions; verify at [VID](https://www.vid.gov.lv/) |
| Lithuania | ~1.77% (employer; burden shifted to employee since 2019) | ~19.5% (incl. pension, health) | "Sodra ceiling" ~60× avg wage/year; verify at [sodra.lt](https://www.sodra.lt/) |
| Luxembourg | ~12-15% | ~12-14% | Ceiling ~€13,518.70/month (5× social min wage, 2026); verify at [ccss.public.lu](https://ccss.public.lu/fr/parametres-sociaux.html) |
| Malta | ~10% | ~10% | Weekly ceiling reset yearly; verify at [CFR](https://cfr.gov.mt/) |
| Netherlands | ~18-20% (varies) | Employee insurance premiums via payroll | Max premium wage ~€79,400/year (2026); verify at [belastingdienst.nl](https://www.belastingdienst.nl/) |
| Poland | ~19-22% | ~13.7% | Pension/disability base capped at 30× projected avg monthly salary/year; verify at [ZUS](https://www.zus.pl/) |
| Portugal | ~23.75% | ~11% | No ceiling |
| Romania | ~2.25% (CAM) | ~35% (CAS 25% + CASS 10%) | Burden largely on employee; verify at [ANAF](https://www.anaf.ro/) |
| Slovakia | ~35.2% | ~13.4% | Ceiling ~7× avg monthly wage; verify at [socpoist.sk](https://www.socpoist.sk/) |
| Slovenia | ~16.1% | ~22.1% | No ceiling for most |
| Spain | ~30% | ~6.47% (+ MEI solidarity) | Max base ~€5,101.20/month (2026); additional "solidarity quota" on earnings above the cap (phasing in to 2045). Verify at [seg-social.es](https://www.seg-social.es/) |
| Sweden | ~31.42% | ~7% (pension contribution) | Reduced employer rate for young/old workers; verify at [skatteverket.se](https://www.skatteverket.se/) |
...
| Ireland | Knowledge Development Box (KDB) | ~10% (relief reduces the 12.5% rate) | Nexus. Patents, copyrighted software; SME-friendly. Verify current relief at [Revenue](https://www.revenue.ie/). |
...
**Authoritative cross-country sources to re-verify against:** [PwC Worldwide Tax Summaries](https://taxsummaries.pwc.com/) · [Tax Foundation EU data](https://taxfoundation.org/data/all/eu/) · [EU VAT rates / TEDB](https://ec.europa.eu/taxation_customs/tedb/) · [VIES VAT number check](https://ec.europa.eu/taxation_customs/vies/) · [EU taxation & customs portal](https://taxation-customs.ec.europa.eu/) · [OECD BEPS / Pillar Two](https://www.oecd.org/tax/beps/).
